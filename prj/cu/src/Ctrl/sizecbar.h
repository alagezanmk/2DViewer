...
class CU_EXT_CLASS CSCBDockBar : public CDockBar
{
...
class CU_EXT_CLASS CSizingControlBar;
typedef CTypedPtrArray <CPtrArray, CSizingControlBar*> CSCBArray;

class CU_EXT_CLASS CSizingControlBar : public baseCSizingControlBar
{
